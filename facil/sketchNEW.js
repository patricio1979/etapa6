...
function draw() {
    ...
    if (previous) {
        ...
        Primero identifica los pedales IZQUIERDO y DERECHO.
        
        Iniciando verás un punto para fijar la mirada (un signo de + ).
        Después aparecerá la imagen de un intervalo de alturas.
        Cuando lo hayas indentificado, mantén presionado el pedal DERECHO y 
        mencionas en voz alta qué intervalo viste (distancia y cualidad).
        Por ejemplo "Cuarta Justa", "Tercera Mayor", "Sexta Menor", etc.) y luego lo sueltas.
...
function changeBG() {
    ...
    switch (strin) {
        case "1":
          console.log("Condición 1a, fácil-intermedio-difícil");
          sequenceComplete = stimCondOne
          break;
        case "2":
          console.log("Condición 1b, fácil-intermedio-difícil");
          sequenceComplete = stimCondTwo
          break;
        case "3":
            console.log("Condición 2a, difícil-intermedio-fácil");
            sequenceComplete = stimCondThree
          break;
        case "4":
            console.log("Condición 2b, difícil-intermedio-fácil");
